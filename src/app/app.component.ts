...
@Component({
  ...
  imports: [CommonModule, RouterModule, PIcon, RouterOutlet, TooltipModule, ReactiveFormsModule, ButtonModule, DialogModule, ToastModule, ConfirmDialogModule, ToggleSwitchModule, InputTextModule, PasswordModule, AnimationComponent, ProgressSpinnerModule],
...
export class AppComponent implements OnInit {
  ...
  applyPreset = () => {
    this.primeng.setConfig({
      theme: {
        preset: this.enableMatrix ? Matrix : Amber,
      },
    });
    this.animate();
  };
