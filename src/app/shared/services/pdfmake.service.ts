                  ...
                  [
                    {
                      fillColor: "#fbbf24",
                      stack: [
                        { image: profilePicture, width: pageWidth * (colwidth / 100) - margin - padding * 2, alignment: "center" },
                        { text: "Coordonnées", style: ["title3", "text3"], bold: true },
                          ...
                          stack: [
                            ...
                            ...this.skills
                              ...
                              .map((skill): Content => ({
                                ...
                                table: {
                                  widths: ["auto", "*", "auto"],
                                  body: [[skill.icon ? { svg: iconCache.get(skill.icon)!, width: iconSize } : { text: skill.title[0].toUpperCase(), fontSize: iconSize, bold: true }, { text: skill.title, style: "text5", marginLeft: 2, verticalAlignment: "middle" }, { canvas: generateDotsCanvas(skill.level, "#525252"), verticalAlignment: "middle" }]],
                                },
                              })),
                          ],
                        })),
