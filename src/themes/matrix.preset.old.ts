...
export const Matrix: Preset = definePreset(Aura, {
  ...
  semantic: {
    ...
    iconSize: "1rem",
    anchorGutter: "2px",
    primary: { 50: "#f2fcf2", 100: "#c2f2c2", 200: "#91e791", 300: "#61dd61", 400: "#30d230", 500: "#00c800", 600: "#00aa00", 700: "#008c00", 800: "#006e00", 900: "#005000", 950: "#003200" },
    formField: {
      paddingX: "0.75rem",
      paddingY: "0.5rem",
    ...
    list: {
      ...
      option: { padding: "0.5rem 0.75rem", borderRadius: "0" },
    ...
    overlay: {
      select: { borderRadius: "0", shadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" },
      popover: { borderRadius: "0", padding: "0.75rem", shadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" },
      modal: { borderRadius: "0", padding: "1.25rem", shadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1)" },
    ...
    colorScheme: {
      ...
      light: {
        ...
        primary: { color: "{primary.500}", contrastColor: "{surface.900}", hoverColor: "{primary.300}", activeColor: "{primary.200}" },
        highlight: {
  ...
  components: {
    ...
    badge: {
      root: { borderRadius: "0", padding: "0 0.5rem", fontSize: "0.75rem", fontWeight: "700", minWidth: "1.5rem", height: "1.5rem" },
      dot: { size: "0.5rem" },
    ...
    card: {
      root: { background: "{content.background}", borderRadius: "0", color: "{content.color}", shadow: "0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1)" },
    ...
    chip: {
      root: { borderRadius: "0", paddingX: "0.75rem", paddingY: "0.5rem", gap: "0.5rem", transitionDuration: "{transition.duration}" },
      image: { width: "2rem", height: "2rem" },
      icon: { size: "1rem" },
      removeIcon: {
        size: "1rem",
        focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{form.field.focus.ring.shadow}" },
      },
      colorScheme: {
    ...
    confirmdialog: { icon: { size: "2rem", color: "{overlay.modal.color}" }, content: { gap: "1rem" } },
    confirmpopup: {
      root: {
    ...
    datatable: {
      root: { transitionDuration: "{transition.duration}" },
      header: { background: "{content.background}", borderColor: "{datatable.border.color}", color: "{content.color}", borderWidth: "0 0 1px 0", padding: "0.75rem 1rem" },
      headerCell: {
        background: "{content.background}",
        hoverBackground: "{content.hover.background}",
        selectedBackground: "{highlight.background}",
      ...
      footerCell: { background: "{content.background}", borderColor: "{datatable.border.color}", color: "{content.color}", padding: "0.75rem 1rem" },
      columnFooter: { fontWeight: "600" },
      footer: { background: "{content.background}", borderColor: "{datatable.border.color}", color: "{content.color}", borderWidth: "0 0 1px 0", padding: "0.75rem 1rem" },
    ...
    dock: {
      root: { background: "rgba(255, 255, 255, 0.1)", borderColor: "rgba(255, 255, 255, 0.2)", padding: "0.5rem", borderRadius: "0" },
      item: {
        borderRadius: "{content.border.radius}",
        padding: "0.5rem",
        size: "3rem",
    ...
    floatlabel: {
      ...
      on: { borderRadius: "0", active: { background: "{form.field.background}", padding: "0 0.125rem" } },
    },
    galleria: {
    ...
    inputotp: { root: { gap: "0.5rem" }, input: { width: "2.5rem", sm: { width: "2rem" }, lg: { width: "3rem" } } },
    inputtext: {
      root: {
        background: "{form.field.background}",
        disabledBackground: "{form.field.disabled.background}",
    ...
    message: {
      ...
      closeButton: { width: "1.75rem", height: "1.75rem", borderRadius: "0", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", offset: "{focus.ring.offset}" } },
    ...
    orderlist: { root: { gap: "1.125rem" }, controls: { gap: "0.5rem" } },
    organizationchart: {
    ...
    picklist: { root: { gap: "1.125rem" }, controls: { gap: "0.5rem" } },
    progressbar: {
    ...
    slider: {
      ...
      handle: {
        ...
        content: { borderRadius: "0", hoverBackground: "{content.background}", width: "16px", height: "16px", shadow: "0px 0.5px 0px 0px rgba(0, 0, 0, 0.08), 0px 1px 1px 0px rgba(0, 0, 0, 0.14)" },
        focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" },
      },
      colorScheme: { light: { handle: { background: "{surface.0}" } }, dark: { handle: { background: "{surface.950}" } } },
    },
    ...
    tag: {
      root: { fontSize: "0.875rem", fontWeight: "700", padding: "0.25rem 0.5rem", gap: "0.25rem", borderRadius: "{content.border.radius}", roundedBorderRadius: "0" },
      icon: { size: "0.75rem" },
      colorScheme: {
        light: {
    ...
    timeline: {
      ...
      eventMarker: {
        ...
        background: "{content.background}",
        borderColor: "{content.border.color}",
        content: { borderRadius: "0", size: "0.375rem", background: "{primary.color}", insetShadow: "0px 0.5px 0px 0px rgba(0, 0, 0, 0.06), 0px 1px 1px 0px rgba(0, 0, 0, 0.12)" },
      },
    ...
    togglebutton: {
      root: {
        ...
        focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" },
        transitionDuration: "{form.field.transition.duration}",
        sm: { fontSize: "{form.field.sm.font.size}", padding: "0.375rem 0.75rem" },
        lg: { fontSize: "{form.field.lg.font.size}", padding: "0.625rem 1.25rem" },
      },
      icon: { disabledColor: "{form.field.disabled.color}" },
      content: { padding: "0.25rem", checkedShadow: "0px 1px 2px 0px rgba(0, 0, 0, 0.02), 0px 1px 2px 0px rgba(0, 0, 0, 0.04)" },
      colorScheme: {
        light: {
          root: {
            background: "{surface.100}",
    ...
    toggleswitch: {
      ...
      handle: { borderRadius: "0", size: "1rem" },
      colorScheme: {
        light: {
          root: {
    ...
    toolbar: {
      root: { background: "{content.background}", borderColor: "{content.border.color}", borderRadius: "{content.border.radius}", color: "{content.color}", gap: "0.5rem", padding: "0.75rem" },
    },
    virtualscroller: { loader: { mask: { background: "{content.background}", color: "{text.muted.color}" }, icon: { size: "2rem" } } },
    tooltip: {
    ...
    ripple: { colorScheme: { light: { root: { background: "rgba(0,0,0,0.1)" } }, dark: { root: { background: "rgba(255,255,255,0.3)" } } } },
  },
});
